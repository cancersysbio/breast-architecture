### CREATE EXTENDED DATA FIGURE 4E #############################################################################
# Barplot of amplicon overlap (Primary)
...
### MAIN ##########################################################################################
# Cytoband amplicons
coamp_long <- read.delim(file.path(main_repo_path, "data", "ExtendedData4e_sourcetable1.txt"), sep = ",")
...
# SV 
samples_sv_type_in_amplicon <- read.delim(file.path(main_repo_path, "data", "ExtendedData4e_sourcetable2.txt"), sep = ",")

# Amplicon genes and ecDNA ----
her2_ecdna_df <- read.delim(file.path(main_repo_path, "data", "ExtendedData4e_sourcetable3.txt"), sep = ",") %>%
  group_by(Cytoband_hg19) %>%
...
# SAVE ----
pdf(file.path(main_repo_path, "plots", "ExtendedData4e.pdf"), height=4, width=7)
