### CREATE EXTENDED DATA 7L #######################################################################
# percent BP overlap with all r-loops
...
write.table(
	outagg,
	file = file.path(main_repo_path, 'data', 'ExtendedData7l_sourcetable.txt'),
	sep = '\t',
	row.names = FALSE,
	quote = FALSE
	)
