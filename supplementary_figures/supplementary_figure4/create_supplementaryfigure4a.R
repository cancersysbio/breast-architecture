### CREATE SUPPLEMENTARY FIGURE 4A ##############################################################
# create supplementary figure 4a 
# plot NMF diagnostic measures for choice of number of SV signatures in metastatic samples 
### PREAMBLE ######################################################################################
...
diagnostic <- read.csv(
	file.path(main_repo_path, 'data', 'sv_signature_diagnostics_metastatic.csv'),
	as.is = TRUE
	)
...
create.multipanelplot(
	list(p2, p1),
	filename = 'supplementary_figure4a.pdf',
	resolution = 300
	)
